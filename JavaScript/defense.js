...
function prepareNextWave() {
	...
	if(waveNum === 1) {
		...
		for(let i = 0, j = 398; i < 9; i++, j += 398) {
			enemyArray.push({type: 2, time: j});
		}
		for(let i = 0, j = 100; i < 20; i++, j += 150) {
		...
		for(let i = 0, j = 1500; i < 20; i++, j += 60) {
			enemyArray.push({type: 4, time: j});
		}
		for(let i = 0, j = 3000; i < 20; i++, j += 60) {
			enemyArray.push({type: 4, time: j});
		}
		...
		for(let i = 0, j = 100; i < 50; i++, j += 200) {
			enemyArray.push({type: 4, time: j});
		}
		...
		for(let i = 0, j = 460; i < 10; i++, j += 40) {
			enemyArray.push({type: 3, time: j});
		}
		for(let i = 0, j = 860; i < 10; i++, j += 40) {
			enemyArray.push({type: 4, time: j});
		}
		for(let i = 0, j = 1260; i < 10; i++, j += 40) {
		...
		for(let i = 0, j = 2000; i < 5; i++, j += 20) {
			enemyArray.push({type: 7, time: j});
		}
		for(let i = 0, j = 5000; i < 5; i++, j += 20) {
			enemyArray.push({type: 7, time: j});
		}
